...
namespace Universe {
    // this should be replaced with the class included in Forge.Utilities
    public struct Real {
        ...
        public static Real Random(Random r)
        {
            Real real;
    ...
    public struct RealVector
    {
        public static RealVector Create(Real x, Real y, Real z)
        {
            RealVector vec;
            vec.x = x;
            vec.y = y;
        ...
        public static readonly RealVector zero = Create(0, 0, 0);

        public static RealVector operator +(RealVector one, RealVector other)
        {
            RealVector output;
        ...
        public static Real DistanceSq(RealVector one, RealVector other)
        {
            Real dx = one.x - other.x, dy = one.y - other.y, dz = one.z - other.z;
            return dx * dx + dy * dy + dz * dz;
        }

        public static Real Distance(RealVector one, RealVector other)
        {
