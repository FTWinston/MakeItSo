...
export const EffectIndicators = () => {
    const [effects, setEffects] = useState(() => {
        ...
        return [
            ...
            { id: 2, startTime: now - durationToTicks(15), endTime: determineEndTime(14, now), positive: false, type: SystemStatusEffectType.Boost2 },
            { id: 3, startTime: now - durationToTicks(7), endTime: determineEndTime(25, now), positive: true, type: SystemStatusEffectType.Boost1 },
            { id: 4, startTime: now - durationToTicks(5), endTime: determineEndTime(16, now), positive: true, type: SystemStatusEffectType.Boost2 },
            ...
            { id: 8, startTime: now - durationToTicks(5), endTime: determineEndTime(11, now), positive: true, type: SystemStatusEffectType.Boost2 },
            { id: 9, startTime: now - durationToTicks(1), endTime: determineEndTime(6, now), positive: true, type: SystemStatusEffectType.Boost1 },
